...
class disambiguateFinalStatesZZ : public TSelector {
   public:
    TTree *fChain;
    ...
    // disambiguateFinalStatesZZ(TTree * /*tree*/ =0) : fChain(0),
    // fBestCandidateEntryList(0), /*fCutFormula(0),*/ fCurrentRun(-1),
    // fCurrentEvt(-1) { }
    disambiguateFinalStatesZZ(TTree * /*tree*/ = 0)
        : fChain(0),
          fBestCandidateEntryList(0),
          fCutFormula(0),
          fCurrentRun(-1),
          fCurrentEvt(-1) {}
    // virtual ~disambiguateFinalStatesZZ() {
    // SafeDelete(fBestCandidateEntryList); /*SafeDelete(fCutFormula)*/; }
    virtual ~disambiguateFinalStatesZZ() {
    ...
    void setZCandidateBranchName(const char *name1, const char *name2,
