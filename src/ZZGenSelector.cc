...
void ZZGenSelector::Init(TTree *tree) {
    ...
    hists1D_ = {
        "GenZ2lep2_Phi", "GenZ2lep2_Pt",  "GenMass",       "Pt",
        "nJets",         "nJetCSVv2T",    "Genyield",      "GenZMass",
        "GenZ1Mass",     "GenZ2Mass",     "GenZZPt",       "GenZZEta",
        "GenZ1Pt",       "GenZ2Pt",       "GenZPt",        "GenZ1Phi",
        "GenZ2Phi",      "GendPhiZ1Z2",   "GenLepPt",      "GenLepEta",
        "GenLep12Pt",    "GenLep12Eta",   "GenLep34Pt",    "GenLep34Eta",
        "GenZ1lep1_Eta", "GenZ1lep1_Phi", "GenZ1lep1_Pt",  "GenZ1lep2_Eta",
        "GenZ1lep2_Phi", "GenZ1lep2_Pt",  "GenZ2lep1_Eta", "GenZ2lep1_Phi",
        "GenZ2lep1_Pt",  "GenZ2lep2_Eta",
    };
...
void ZZGenSelector::LoadBranchesUWVV(
...
void ZZGenSelector::LoadBranchesNanoAOD(
    Long64_t entry, std::pair<Systematic, std::string> variation) {
...
void ZZGenSelector::SetBranchesUWVV() {
    ...
    // Add 2e2mu channel also but it still needs to differentiate which one is
    // Z1Mass and which one is Z2Mass leptons This is done with a flag at the
    // time of Process for each event on the fly
    else if (channel_ == eemm) {
        fChain->SetBranchAddress("e1_e2_Mass", &GenZ1mass, &b_GenZ1mass);
...
bool ZZGenSelector::ZZSelection() {
    if ((GenZ1mass > 60.0 && GenZ1mass < 120.0) &&
        (GenZ2mass > 60.0 && GenZ2mass < 120.0))
        return true;
    else
        return false;
}
...
void ZZGenSelector::FillHistograms(
    Long64_t entry, std::pair<Systematic, std::string> variation) {
    if (!ZZSelection()) return;
    SafeHistFill(histMap1D_, "Genyield", channel_, variation.first, 1,
                 Genweight);
    SafeHistFill(histMap1D_, "GenMass", channel_, variation.first, GenMass,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZMass", channel_, variation.first, GenZ1mass,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZMass", channel_, variation.first, GenZ2mass,
                 Genweight);
    // Making LeptonPt and Eta plots
    SafeHistFill(histMap1D_, "GenLepPt", channel_, variation.first, Genl1Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLepPt", channel_, variation.first, Genl2Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLepPt", channel_, variation.first, Genl3Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLepPt", channel_, variation.first, Genl4Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLepEta", channel_, variation.first, Genl1Eta,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLepEta", channel_, variation.first, Genl2Eta,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLepEta", channel_, variation.first, Genl3Eta,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLepEta", channel_, variation.first, Genl4Eta,
                 Genweight);
    // Summing 12,34 leptons
    SafeHistFill(histMap1D_, "GenLep12Pt", channel_, variation.first, Genl1Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLep12Pt", channel_, variation.first, Genl2Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLep34Pt", channel_, variation.first, Genl3Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLep34Pt", channel_, variation.first, Genl4Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLep12Eta", channel_, variation.first, Genl1Eta,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLep12Eta", channel_, variation.first, Genl2Eta,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLep34Eta", channel_, variation.first, Genl3Eta,
                 Genweight);
    SafeHistFill(histMap1D_, "GenLep34Eta", channel_, variation.first, Genl4Eta,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZ1Mass", channel_, variation.first, GenZ1mass,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZ2Mass", channel_, variation.first, GenZ2mass,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZPt", channel_, variation.first, GenZ1pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZPt", channel_, variation.first, GenZ2pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZ1Pt", channel_, variation.first, GenZ1pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZ2Pt", channel_, variation.first, GenZ2pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZZPt", channel_, variation.first, GenPt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZZEta", channel_, variation.first, GenEta,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZ1Phi", channel_, variation.first, GenZ1Phi,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZ2Phi", channel_, variation.first, GenZ2Phi,
                 Genweight);
    SafeHistFill(histMap1D_, "GendPhiZ1Z2", channel_, variation.first,
                 GendPhiZZ, Genweight);
    SafeHistFill(histMap1D_, "GenZ1lep1_Pt", channel_, variation.first, Genl1Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZ1lep1_Eta", channel_, variation.first,
                 Genl1Eta, Genweight);
    SafeHistFill(histMap1D_, "GenZ1lep1_Phi", channel_, variation.first,
                 Genl1Phi, Genweight);
    SafeHistFill(histMap1D_, "GenZ1lep2_Pt", channel_, variation.first, Genl2Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZ1lep2_Eta", channel_, variation.first,
                 Genl2Eta, Genweight);
    SafeHistFill(histMap1D_, "GenZ1lep2_Phi", channel_, variation.first,
                 Genl2Phi, Genweight);
    SafeHistFill(histMap1D_, "GenZ2lep1_Pt", channel_, variation.first, Genl3Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZ2lep1_Eta", channel_, variation.first,
                 Genl3Eta, Genweight);
    SafeHistFill(histMap1D_, "GenZ2lep1_Phi", channel_, variation.first,
                 Genl3Phi, Genweight);
    SafeHistFill(histMap1D_, "GenZ2lep2_Pt", channel_, variation.first, Genl4Pt,
                 Genweight);
    SafeHistFill(histMap1D_, "GenZ2lep2_Eta", channel_, variation.first,
                 Genl4Eta, Genweight);
    SafeHistFill(histMap1D_, "GenZ2lep2_Phi", channel_, variation.first,
                 Genl4Phi, Genweight);
    // 2D Z1 vs Z2
    // SafeHistFill(hists2D_, "GenZ1Mass_GenZ2Mass", channel_,
    // variation.first,GenZ1mass,GenZ2mass,Genweight);
}
